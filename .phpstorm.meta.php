...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/web-karyawan/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/web-karyawan/public/storage','logging.default','logging.deprecations.channel',
...
'cors.supports_credentials','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities','dompdf.options.font_dir',
...
'admin.dashboard','employees.index','employees.create','employees.store','employees.show',
'employees.edit','employees.update','employees.destroy','attendances.index','attendances.create',
'attendances.store','attendances.show','attendances.edit','attendances.update','attendances.destroy',
'salaries.index','salaries.create','salaries.store','salaries.show','salaries.edit',
'salaries.update','salaries.destroy','salaries.payslip','employee.dashboard','attendance.clockIn',
'attendance.clockOut','employee.attendance.history','employee.salary.history','storage.local',);
        registerArgumentsSet('views', 
'admin.attendances.create','admin.attendances.edit','admin.attendances.index','admin.attendances.show','admin.dashboard',
'admin.employees.create','admin.employees.edit','admin.employees.index','admin.employees.show','admin.salaries.create',
'admin.salaries.edit','admin.salaries.index','admin.salaries.payslip','admin.salaries.show','auth.login',
'employee.attendances.history','employee.dashboard','employee.salaries.history','layouts.app','layouts.sidebar',
